<x-layout>
    <link rel="stylesheet" href="{{ asset('css/css-package-gourmet/styles.css') }}">

    {{-- barre de navigation --}}
    <x-nav></x-nav>

    {{-- section titre forfait--}}
        <div class="header-picture-package-gourmet">
        ...
        {{-- section description chambre/activité --}}
        <div id="app_packages" v-cloak>
            <div class="main_package-gourmet">
                {{-- room --}}
                <div class="description-room-gourmet" :class="{ouvert: classe_active1}">
                    <div class="room1" >
                        <img src="images\chambre-gourmet.jpg" alt="room1">
                    </div>
                    <div class="text">
                        <p>DELUXE ROOM</p>
                ...
                {{-- activité --}}
                <div class="description-package" :class="{ouvert1: classe_active2}">
                    <div class="room2" >
                        <img src="images\sushi.jpg" alt="room1">
                    </div>
                    <div class="text2">
                        <p> {{ strtoupper($packages->title) }}</p>
